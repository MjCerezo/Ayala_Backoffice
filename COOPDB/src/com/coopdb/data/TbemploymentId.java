...
/**
 *  COOPDB.TbemploymentId
 *  02/27/2018 10:04:59
 * 
 */
public class TbemploymentId
    implements Serializable
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TbemploymentId)) {
            return false;
        }
        TbemploymentId other = ((TbemploymentId) o);
        if (this.id == null) {
            if (other.id!= null) {
                return false;
            }
        ...
        if (this.areacodephone == null) {
            if (other.areacodephone!= null) {
                return false;
            }
        } else {
            if (!this.areacodephone.equals(other.areacodephone)) {
                return false;
            }
        }
        if (this.phoneno == null) {
            ...
            if (!this.phoneno.equals(other.phoneno)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        ...
        rtn = (rtn* 37);
        if (this.areacodephone!= null) {
            rtn = (rtn + this.areacodephone.hashCode());
        }
        rtn = (rtn* 37);
        if (this.phoneno!= null) {
            rtn = (rtn + this.phoneno.hashCode());
        }
        return rtn;
    }
