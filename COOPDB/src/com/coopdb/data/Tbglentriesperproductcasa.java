...
/**
 *  COOPDB.Tbglentriesperproductcasa
 *  08/10/2024 21:24:57
 * 
 */
public class Tbglentriesperproductcasa {

    private TbglentriesperproductcasaId id;
    ...
    public TbglentriesperproductcasaId getId() {
        return id;
    }

    public void setId(TbglentriesperproductcasaId id) {
        this.id = id;
    }
