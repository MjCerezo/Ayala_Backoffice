...
public class Tblstapp {
    ...
    private String disbursementacctno;
    ...
    public String getDisbursementacctno() {
        return disbursementacctno;
    }

    public void setDisbursementacctno(String disbursementacctno) {
        this.disbursementacctno = disbursementacctno;
    }
    ...
    public Boolean getDeviationflag() {
