...
public class Tbdeptxjrnl {
    ...
    public Integer getTxjrnlno() {
        return txjrnlno;
    }

    public void setTxjrnlno(Integer txjrnlno) {
        this.txjrnlno = txjrnlno;
    }
    ...
    public Date getOverridestatusdate() {
        return overridestatusdate;
    }

    public void setOverridestatusdate(Date overridestatusdate) {
        this.overridestatusdate = overridestatusdate;
    }
