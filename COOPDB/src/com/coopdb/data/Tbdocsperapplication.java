...
/**
 *  COOPDB.Tbdocsperapplication
 *  08/10/2024 21:24:57
 * 
 */
public class Tbdocsperapplication {
    ...
    private String docappstatus;
    private Integer applicationstatus;
    private Integer docchecklistid;
    private String docanalystremarks;
    private String txcode;
    private String docbasecode;
    private String filename;
    private Date datereqsubmission;
    private Date datesubmitted;
    private Date applicationdate;
    private Date cfeffectivedate;
    private Date cfexpirydate;
    ...
    public String getDocappstatus() {
        return docappstatus;
    }

    public void setDocappstatus(String docappstatus) {
        this.docappstatus = docappstatus;
    }
    ...
    public Integer getDocchecklistid() {
        return docchecklistid;
    }

    public void setDocchecklistid(Integer docchecklistid) {
    ...
    public Date getCfeffectivedate() {
        return cfeffectivedate;
    }

    public void setCfeffectivedate(Date cfeffectivedate) {
        this.cfeffectivedate = cfeffectivedate;
    }

    public Date getCfexpirydate() {
        return cfexpirydate;
    }

    public void setCfexpirydate(Date cfexpirydate) {
        this.cfexpirydate = cfexpirydate;
    }
    ...
    public String getCifnosurety() {
        return cifnosurety;
    }

    public void setCifnosurety(String cifnosurety) {
        this.cifnosurety = cifnosurety;
    }
