...
/**
 *  COOPDB.Tbglmatrixperprodcasa
 *  08/10/2024 21:24:57
 * 
 */
public class Tbglmatrixperprodcasa {

    private TbglmatrixperprodcasaId id;
    ...
    public TbglmatrixperprodcasaId getId() {
        return id;
    }

    public void setId(TbglmatrixperprodcasaId id) {
        this.id = id;
    }
