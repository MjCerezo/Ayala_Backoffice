    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.coopdb.data.Tbbireportmain getTbbireportmainById(String id, PagingOptions pagingOptions) {
        List<com.coopdb.data.Tbbireportmain> rtn = ((List<com.coopdb.data.Tbbireportmain> ) dsMgr.invoke(taskMgr.getQueryTask(), (COOPDBConstants.getTbbireportmainByIdQueryName), id, pagingOptions));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
