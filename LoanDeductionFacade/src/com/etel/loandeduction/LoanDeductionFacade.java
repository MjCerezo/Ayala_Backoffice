 ...
 */
@ExposeToClient
public class LoanDeductionFacade extends JavaServiceSuperClass {
	/*
	 ...
	 */
	public LoanDeductionFacade() {
		super(INFO);
	}

	LoanDeductionService srvc = new LoanDeductionServiceImpl();

	public String saveDeduction(Tbloandeduction loandeduction) {
		return srvc.saveDeduction(loandeduction);
	}

	public String deleteDeduction(Tbloandeduction loandeduction) {
		return srvc.deleteDeduction(loandeduction);
	}

	public List<Tbloandeduction> listDeductions(String appno) {
		return srvc.listDeductions(appno);
	}
}
