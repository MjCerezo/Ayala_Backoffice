...
public class LoanTransactionEntryForm {
	...
	String checkaccountno;
	String checkaccountname;
	String checktype;
	String checkpayee;
	String checkbankbr;
	String debitacctno;
	String debitaccttype;
	Date approvaldate;
	...
	public String getCheckbankbr() {
		return checkbankbr;
	}
	public void setCheckbankbr(String checkbankbr) {
		this.checkbankbr = checkbankbr;
	}
