package com.etel.amla.forms;

import java.util.Date;

public class AmlaForm {
	...
	public Boolean getOpenendeddate() {
		return openendeddate;
	}
	public void setOpenendeddate(Boolean openendeddate) {
