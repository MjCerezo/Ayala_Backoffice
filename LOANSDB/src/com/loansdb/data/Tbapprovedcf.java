...
/**
 *  LOANSDB.Tbapprovedcf
 *  10/13/2020 10:21:35
 * 
 */
public class Tbapprovedcf {

    private TbapprovedcfId id;
    ...
    private String prevcfrefno;
    private Date cfdatecreated;
    private String cfcreatedby;
    private BigDecimal cflpcrate;

    public TbapprovedcfId getId() {
        return id;
    }

    public void setId(TbapprovedcfId id) {
        this.id = id;
    }
    ...
    public String getCflastupdateby() {
        return cflastupdateby;
    }

    public void setCflastupdateby(String cflastupdateby) {
        this.cflastupdateby = cflastupdateby;
    }
    ...
    public String getPrevcfrefno() {
        return prevcfrefno;
    }

    public void setPrevcfrefno(String prevcfrefno) {
        this.prevcfrefno = prevcfrefno;
    }

    public Date getCfdatecreated() {
        return cfdatecreated;
    }

    public void setCfdatecreated(Date cfdatecreated) {
        this.cfdatecreated = cfdatecreated;
    }

    public String getCfcreatedby() {
        return cfcreatedby;
    }

    public void setCfcreatedby(String cfcreatedby) {
        this.cfcreatedby = cfcreatedby;
    }
